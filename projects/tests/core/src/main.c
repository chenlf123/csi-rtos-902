...
#if !defined(__CK810) && !defined(__CK807)
        { "test_prsr", test_prsr, 1 },
#endif
        { "test_vbr", test_vbr, 1 },
        { "test_psr", test_psr, 1 },
        { "test_epc", test_epc, 1 },
...
#if defined(__CK810) || defined(__CK807) || defined(__CK610)
#ifdef CONFIG_CHIP_SH610M
        { "test_mmu_ck610m", test_mmu_ck610m, 1},
#else
#ifndef CONFIG_CHIP_SH610
        { "test_mmu", test_mmu, 1},
#endif
#endif
#endif
#if defined(__CK610) || defined(__CK801) || defined(__CK802) || defined(__CK803)
#ifdef CONFIG_CHIP_SH610
        { "test_mpu", test_mpu, 1},
#endif
#endif
//        { "test_systick", test_systick },
//        { "test_case1", test_case1 },
//        { "test_vic_test", test_vic_test},
        { NULL, NULL }
    };
