...
void Example_TaskHi()
{
    ...
    printf("TaskHi csi_kernel_task_resume return success.\r\n");
...
void Example_TaskLo()
{
    ...
    printf("TaskHi csi_kernel_task_suspend return success.\r\n");
...
void example_main(void)
{
    ...
    printf("csi_kernel_suspend return success!\r\n");
    ...
    printf("Example_TaskHi created successfully!\r\n");
    ...
    printf("Example_TaskLo created return success!\r\n");
