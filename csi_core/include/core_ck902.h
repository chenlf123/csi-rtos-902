...
/******************************************************************************
 * @file     core_ck902.h
 * @brief    CSI CK902 Core Peripheral Access Layer Header File
 * @version  V1.0
 * @date     02. June 2017
 ******************************************************************************/

#ifndef __CORE_CK902_H_GENERIC
#define __CORE_CK902_H_GENERIC
...
/*  CSI CK902 definitions */
#define __CK902_CSI_VERSION_MAIN  (0x04U)                                      /*!< [31:16] CSI HAL main version */
#define __CK902_CSI_VERSION_SUB   (0x1EU)                                      /*!< [15:0]  CSI HAL sub version */
#define __CK902_CSI_VERSION       ((__CK902_CSI_VERSION_MAIN << 16U) | \
                                   __CK902_CSI_VERSION_SUB           )        /*!< CSI HAL version number */
...
#endif /* __CORE_CK902_H_GENERIC */

#ifndef __CSI_GENERIC

#ifndef __CORE_CK902_H_DEPENDANT
#define __CORE_CK902_H_DEPENDANT
...
/* Memory mapping of CK902 Hardware */
...
#endif /* __CORE_CK902_H_DEPENDANT */
